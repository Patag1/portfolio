    ...
    <section>
      <div className="flex justify-between items-center">
        ...
        <div className="relative [&>div]:hover:opacity-100 md:[&>div]:hover:-translate-x-8 [&>div]:hover:-translate-x-2 mb-2">
          ...
          />
          <div
            className={`${gambetta.className} absolute w-fit h-fit opacity-0 top-1/2 bottom-1/2 right-16 -translate-y-1/2 pointer-events-none transition-all ease-in-out whitespace-nowrap text-xs bg-black text-gray-200 px-2 py-1 font-extrabold`}
          >
            Augusto Sasso
          </div>
        </div>
